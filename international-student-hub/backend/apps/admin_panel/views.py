...
class UserProfileViewSet(AdminModelViewSet):
    ...
    ordering_fields = [
        "id", "user__username", "country", "university", "arrival_date",
...
class ChecklistCategoryViewSet(AdminModelViewSet):
    ...
    ordering_fields = ["id", "name", "description", "order", "icon"]
...
class ChecklistItemViewSet(AdminModelViewSet):
    ...
    ordering_fields = [
        "id", "category__name", "title", "slug", "description",
...
class UserChecklistProgressViewSet(AdminModelViewSet):
    ...
    ordering_fields = ["id", "user__username", "item__title", "completed", "completed_at"]
...
class ServiceCategoryViewSet(AdminModelViewSet):
    ...
    ordering_fields = ["id", "name", "slug", "description", "icon", "order"]
...
class ServiceEntryViewSet(AdminModelViewSet):
    ...
    ordering_fields = [
        "id", "name", "slug", "category__name", "description",
        "detail_description", "address", "latitude", "longitude", "phone",
        "website", "tags", "university", "verified", "hours",
...
class PostViewSet(AdminModelViewSet):
    ...
    ordering_fields = [
        "id", "author__username", "title", "body", "university",
        "upvotes", "is_hidden", "created_at", "updated_at",
    ]
...
class ReplyViewSet(AdminModelViewSet):
    ...
    ordering_fields = [
        "id", "post__title", "author__username", "body", "upvotes",
...
class BotFAQViewSet(AdminModelViewSet):
    ...
    ordering_fields = [
        "id", "trigger_keyword", "response_text", "active",
